...
const navItems = [
  { id: "browse" as RunnerTab, label: "Browse Errands", icon: Compass },
  { id: "gigs" as RunnerTab, label: "My Gigs", icon: ShoppingBag },
  { id: "profile" as RunnerTab, label: "Profile", icon: UserCircle },
];
